...
class VideoDisplayComponent(QWidget):
    ...
    def __init_widgets(self):
        ...
        self.play_button.setFixedSize(26, 20)
        ...
        ctrl_bar.addWidget(self.play_button)

        self.current_time_label = QLabel("00:00:00")
        self.current_time_label.setStyleSheet("color: #cccccc; font-size: 12px; background: transparent;")
        ctrl_bar.addWidget(self.current_time_label)

        sep_label = QLabel("/")
        sep_label.setStyleSheet("color: #666666; font-size: 12px; background: transparent;")
        ctrl_bar.addWidget(sep_label)

        self.total_time_label = QLabel("00:00:00")
        self.total_time_label.setStyleSheet("color: #888888; font-size: 12px; background: transparent;")
        ctrl_bar.addWidget(self.total_time_label)

        ctrl_bar.addStretch(1)
        control_layout.addLayout(ctrl_bar)
    ...
    def update_time_label(self, current_frame, total_frames, fps):
        """更新当前时间和总时长标签"""
        if fps and fps > 0:
            self.current_time_label.setText(self._fmt_time(current_frame / fps))
            self.total_time_label.setText(self._fmt_time(total_frames / fps))
